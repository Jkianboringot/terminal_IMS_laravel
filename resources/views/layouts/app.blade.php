...
<head>
    ...
    <link rel="icon" href="{{ asset('admin-lte/assets/img/ego-profile.jpg') }}" type="image/jpeg">
        ...
        <aside class="app-sidebar bg-inv-primary shadow" data-bs-theme="dark"> <!--begin::Sidebar Brand-->
            <div class="sidebar-brand text-inv-primary"> <!--begin::Brand Link-->
                <a href="/" class="brand-link">
                    <!--begin::Brand Image-->
                    <img src="{{ asset('admin-lte/assets/img/ego-profile.jpg') }}" alt="Ego"
        ...
        <main class="app-main"> <!--begin::App Content Header-->
            <div class="app-content-header"> <!--begin::Container-->
                <div class="container-fluid"> <!--begin::Row-->
                   ...
                   <!-- got rid of the header and the annoying home/product/create inthe side of it -->
