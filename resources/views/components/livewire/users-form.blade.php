...
<div>
    ...
    <div wire:loading class="position-fixed top-0 start-0 w-100 h-100 bg-white bg-opacity-50 d-flex justify-content-center align-items-center z-50">
    ...
    <div class="card" wire:loading.class="opacity-50 pointer-events-none" tabindex="0" wire:keydown.escape="cancel">
        ...
        <form wire:submit.prevent="save">
            <div class="card-body">
                ...
                <button
                    onclick="if(!confirm('Are you sure you want to Create this user?')){event.stopImmediatePropagation(); return false;}"
                    wire:click="save"
