            ...
            <div class="card">
                ...
                <div class="card-body ">
                    <div class="mb-3">
                        ...
                        <input wire:model.live="quotation.quotation_date" type="date" class="form-control" />
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <table class="table">
                                            ...
                                            <td class="text-center">
                                                ...
                                                @endif
                                                 ...
                                                 <button wire:click='addQuantity({{ $key }})' class="btn btn-success">
                                                  ...
                                                  <button   onclick="confirm('Are you sure you want to delete this Quotation')||event.stopImmediatePropagation()"  wire:click='deleteCartItem({{ $key }})' 
                            ...
                            <button
                        onclick="confirm('Are you sure you wish to Update the Quotation')||event.stopImmediatePropagation()"
                        wire:click='makeQuotation' class="btn btn-dark text-inv-secondary w-100">Update Quotation</button>
