                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <table class="table">
                                            ...
                                            <td class="text-center">
                                                ...
                                                @endif
                                                 ...
                                                 <button wire:click='addQuantity({{ $key }})' class="btn btn-success">
                                                  ...
                                                  <button   onclick="confirm('Are you sure you want to delete this Order')||event.stopImmediatePropagation()"  wire:click='deleteCartItem({{ $key }})' 
                            ...
                            <button
                        onclick="confirm('Are you sure you wish to Update the Order')||event.stopImmediatePropagation()"
                        wire:click='makeOrder' class="btn btn-dark text-inv-secondary w-100">Update Order</button>
