            ...
            <div class="card">
                ...
                <div class="card-body ">
                    <div class="mb-3">
                        ...
                        <input wire:model.live="invoice.invoice_date" type="date" class="form-control" />
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <table class="table">
                                            ...
                                            <td class="text-center">
                                                ...
                                                @endif
                                                 ...
                                                 <button wire:click='addQuantity({{ $key }})' class="btn btn-success">
                                                  ...
                                                  <button   onclick="confirm('Are you sure you want to delete this Invoice')||event.stopImmediatePropagation()"  wire:click='deleteCartItem({{ $key }})' 
                            ...
                            <button
                        onclick="confirm('Are you sure you wish to Update the Invoice')||event.stopImmediatePropagation()"
                        wire:click='makeInvoice' class="btn btn-dark text-inv-secondary w-100">Update Invoice</button>
